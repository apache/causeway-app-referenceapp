 ...
 *  under the License.
 */
package demoapp.codegen.demoshowcases.value;

import lombok.Getter;
import lombok.RequiredArgsConstructor;

import demoapp.codegen.demoshowcases.value.ValueTypeGenTemplate.Config;
import demoapp.codegen.demoshowcases.value.ValueTypeGenTemplate.Template;
import demoapp.codegen.demoshowcases.value.ValueTypeGenTemplate.TemplateVariant;
...
//            .templateVariant(TemplateVariant.DEFAULT)),
    CALENDAREVENT(Config.builder()
            ...
            .javaPackage("demoapp.dom.featured.causewayext.cal")
